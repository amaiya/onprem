...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'onprem.console': {},
            ...
            'onprem.pipelines.classifier': { 'onprem.pipelines.classifier.FewShotClassifier': ( 'pipelines.classifier.html#fewshotclassifier',
                                             ...
                                             'onprem.pipelines.classifier.FewShotClassifier.__init__': ( 'pipelines.classifier.html#fewshotclassifier.__init__',
                                                                                                         'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.arrays2dataset': ( 'pipelines.classifier.html#fewshotclassifier.arrays2dataset',
                                                                                                               'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.dataset2arrays': ( 'pipelines.classifier.html#fewshotclassifier.dataset2arrays',
                                                                                                               'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.evaluate': ( 'pipelines.classifier.html#fewshotclassifier.evaluate',
                                                                                                         'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.explain': ( 'pipelines.classifier.html#fewshotclassifier.explain',
                                                                                                        'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.get_trainer': ( 'pipelines.classifier.html#fewshotclassifier.get_trainer',
                                                                                                            'onprem/pipelines/classifier.py'),
                                             'onprem.pipelines.classifier.FewShotClassifier.sample_examples': ( 'pipelines.classifier.html#fewshotclassifier.sample_examples',
                                                                                                                'onprem/pipelines/classifier.py'),
