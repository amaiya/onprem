...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'onprem.console': {},
            ...
            'onprem.helpers': { 'onprem.helpers.Classifier': ('pipelines.classifier.html#classifier', 'onprem/helpers.py'),
                                'onprem.helpers.Classifier.__init__': ( 'pipelines.classifier.html#classifier.__init__',
                                                                        'onprem/helpers.py'),
                                'onprem.helpers.Classifier.arrays2dataset': ( 'pipelines.classifier.html#classifier.arrays2dataset',
                                                                              'onprem/helpers.py'),
                                'onprem.helpers.Classifier.train': ('pipelines.classifier.html#classifier.train', 'onprem/helpers.py')},
            ...
            'onprem.pipelines': { 'onprem.pipelines.Extractor': ('pipelines.html#extractor', 'onprem/pipelines.py'),
                                  'onprem.pipelines.Extractor.__init__': ('pipelines.html#extractor.__init__', 'onprem/pipelines.py'),
                                  'onprem.pipelines.Extractor.apply': ('pipelines.html#extractor.apply', 'onprem/pipelines.py'),
                                  'onprem.pipelines.Extractor.segment': ('pipelines.html#extractor.segment', 'onprem/pipelines.py'),
                                  'onprem.pipelines.Summarizer': ('pipelines.html#summarizer', 'onprem/pipelines.py'),
