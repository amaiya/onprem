...
# %% auto 0
__all__ = ['DEFAULT_MODEL', 'SMALL_MODEL', 'DATASET_TEXT', 'DATASET_LABEL', 'FewShotClassifier']
...
class FewShotClassifier:
    def __init__(
        ...
        **kwargs,
        ...
        """
        `Classifier` can be used to train and run text classifiers. Currently based on SetFit.
        ...
        **Args:**
        ...
        if use_smaller and model_id_or_path != DEFAULT_MODEL:
            warnings.warn(f'Over-writing supplied model ({model_id_or_path}) with {SMALL_MODEL} because use_smaller=True.')
        self.model_id_or_path = SMALL_MODEL if use_smaller else self.model_id_or_path
