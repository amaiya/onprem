...
# %% auto 0
__all__ = ['CAPTION_STR', 'download', 'get_datadir', 'split_list', 'segment', 'remove_sentence', 'contains_sentence', 'md_to_df',
           'html_to_df', 'df_to_md', 'SafeFormatter', 'format_string', 'get_template_vars']
