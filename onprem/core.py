...
# %% auto 0
__all__ = ['MIN_MODEL_SIZE', 'MISTRAL_MODEL_URL', 'MISTRAL_PROMPT_TEMPLATE', 'ZEPHYR_MODEL_URL', 'ZEPHYR_PROMPT_TEMPLATE',
           'LLAMA_MODEL_URL', 'LLAMA_PROMPT_TEMPLATE', 'MODEL_DICT', 'PROMPT_DICT', 'DEFAULT_MODEL',
...
"""
MODEL_DICT = {'mistral' : MISTRAL_MODEL_URL, 'zephyr':ZEPHYR_MODEL_URL, 'llama' : LLAMA_MODEL_URL}
...
class LLM:
    def __init__(
        ...
        **Args:**
        ...
        if model_url is None and prompt_template is None:
    ...
    def download_model(
        ...
        **Args:**
        ...
        """
        model_url = MODEL_DICT[default_model] if not model_url else model_url
