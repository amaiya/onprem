...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_ingest.search.ipynb.

# %% auto 0
__all__ = ['DEFAULT_SCHEMA', 'default_schema', 'SearchEngine']

# %% ../../nbs/01_ingest.search.ipynb 3
import json
import os
import warnings
...
class SearchEngine:
    ...
    def index_documents(self,
        ...
        """
        Indexes documents. Extra kwargs supplied to `SearchEngine.ix.writer`.
        """
