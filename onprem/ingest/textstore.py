...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_ingest.textstore.ipynb.

# %% auto 0
__all__ = ['DEFAULT_SCHEMA', 'default_schema', 'TextStore']

# %% ../../nbs/01_ingest.textstore.ipynb 3
import json
import os
import warnings
