...
Docs: https://amaiya.github.io/onprem/hf.train.hftrainer.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/05_hf.train.hftrainer.ipynb.
...
from ..models.tokendetection import TokenDetection
...
class HFTrainer(Tensors):
    ...
    def parse(self, updates):
        ...
        args = {"output_dir": "", "save_strategy": "no", "report_to": "none", "log_level": "warning", "disable_tqdm": False, "use_cpu": not Models.hasaccelerator()}
